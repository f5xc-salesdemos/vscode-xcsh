...
[日本語](https://f5-sales-demo.github.io/vscode-xcsh/ja/) | **한국어** |
...
1. [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=RobinMordasiewicz.xcsh)에서
   확장을 설치하세요
2. xcsh 설치: `brew install f5-sales-demo/tap/xcsh`
...
| 통합           | 설치                                    | 인증                |
| -------------- | --------------------------------------- | ------------------- |
| xcsh           | `brew install f5-sales-demo/tap/xcsh` | 설치 시 포함        |
...
전체 문서는
**[https://f5-sales-demo.github.io/vscode-xcsh/](https://f5-sales-demo.github.io/vscode-xcsh/)**에서
확인할 수 있습니다.
